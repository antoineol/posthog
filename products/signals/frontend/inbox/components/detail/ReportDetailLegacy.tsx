 ...
 */
export function ReportDetailSkeletonLegacy(): JSX.Element {
    return (
 ...
 */
function InboxDetailFrameLegacy({
    report,
    tab,
    summary,
    summaryFooter,
...
/**
 * The report detail with the redesign flag off. Unified for Pull requests / Reports / Not actionable. The "Open in GitHub" action
