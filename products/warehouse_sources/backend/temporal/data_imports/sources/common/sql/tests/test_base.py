...
class TestGetSchemas:
    def test_connect_receives_the_team(self) -> None:
        # The host policy exempts the internal-analytics teams, so a connect opened without the
        # team fails closed for them on every driver that goes through this template.
