...
export const FEATURE_FLAGS = {
    ...
    QUERY_SCAN_WARNINGS: 'query-scan-warnings', // owner: #team-analytics-platform, gates the slow query advice surfaces (evaluated server-side per project as a multivariate flag)
