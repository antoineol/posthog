...
CREATE TABLE posthog.sharded_events_json (
  ...
  temporary_properties JSON(max_dynamic_paths=0) TTL toDateTime(inserted_at) + toIntervalDay(60),
  timestamp DateTime64(6, 'UTC'),
  team_id Int64,
  distinct_id String,
