...
# JSON column keeps them as Dynamic paths that read as NULL when absent. `.:Type` extracts the typed value and
# ifNull gives the same '' / 0 default the hinted lc_* columns have.
_COST_PLANNER_ALIAS_COLUMNS = (
    "lc_plan_fingerprint String ALIAS ifNull(log_comment.plan_fingerprint.:String, '')",
    "lc_estimated_rows Int64 ALIAS ifNull(log_comment.estimated_rows.:Int64, 0)",
    "lc_estimated_bytes Int64 ALIAS ifNull(log_comment.estimated_bytes.:Int64, 0)",
)
