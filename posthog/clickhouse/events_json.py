...
EVENTS_PROPERTIES_JSON_SUBCOLUMN_DECLARED_TYPES: dict[str, str] = {
    ...
    "$agent_turn": "String",
    "$ai_audio_cost_usd": "String",
    "$ai_audio_input_tokens": "String",
    "$ai_audio_output_tokens": "String",
    "$ai_batch_run_id": "String",
    "$ai_cache_creation_input_tokens": "String",
    "$ai_cache_read_input_tokens": "String",
    "$ai_error": "String",
    "$ai_error_normalized": "String",
    "$ai_error_type": "String",
    "$ai_evaluation_allows_na": "String",
    "$ai_evaluation_applicable": "String",
    "$ai_evaluation_id": "String",
    "$ai_evaluation_name": "String",
    "$ai_evaluation_reasoning": "String",
    "$ai_evaluation_result": "String",
    "$ai_evaluation_result_type": "String",
    "$ai_evaluation_runtime": "String",
    "$ai_evaluation_skipped": "String",
    "$ai_evaluation_start_time": "String",
    "$ai_evaluation_type": "String",
    "$ai_experiment_id": "String",
    "$ai_framework": "String",
    "$ai_generation_id": "String",
    "$ai_http_status": "String",
    "$ai_image_cost_usd": "String",
    "$ai_image_input_tokens": "String",
    "$ai_image_output_tokens": "String",
    "$ai_input_cost_usd": "String",
    "$ai_input_tokens": "String",
    "$ai_is_error": "String",
    "$ai_latency": "String",
    "$ai_model": "String",
    "$ai_output_cost_usd": "String",
    "$ai_output_tokens": "String",
    "$ai_parent_id": "String",
    "$ai_prompt_name": "String",
    "$ai_provider": "String",
    "$ai_reasoning_tokens": "String",
    "$ai_request_cost_usd": "String",
    "$ai_session_id": "String",
    "$ai_span_name": "String",
    "$ai_span_type": "String",
    "$ai_span_id": "String",
    "$ai_sentiment_label": "String",
    "$ai_sentiment_message_count": "String",
    "$ai_sentiment_score": "String",
    "$ai_target_event_id": "String",
    "$ai_text_input_tokens": "String",
    "$ai_text_output_tokens": "String",
    "$ai_time_to_first_token": "String",
    "$ai_total_cost_usd": "String",
    "$ai_total_tokens": "String",
    "$ai_tools_called": "String",
    "$ai_trace_id": "String",
    "$ai_trace_name": "String",
    "$ai_video_cost_usd": "String",
    "$ai_video_input_tokens": "String",
    "$ai_video_output_tokens": "String",
    "$ai_web_search_cost_usd": "String",
    "$ai_web_search_count": "String",
    "$ai_origin": "String",
    ...
    "$app_version": "String",
    "$autocapture_disabled_server_side": "LowCardinality(String)",
    ...
    "$configured_session_timeout_ms": "String",
    "$current_url": "String",
    "$dead_clicks_enabled_server_side": "LowCardinality(String)",
    "$device": "String",
    "$device_id": "String",
    "$device_model": "String",
    ...
    "$el_text": "String",
    "$event_type": "String",
    "$exception_capture_enabled_server_side": "LowCardinality(String)",
    "$exception_fingerprint": "String",
    "$exception_functions": "Array(String)",
    "$exception_handled": "String",
    "$exception_is_synthetic": "String",
    ...
    "$client_session_initial_utm_campaign": "String",
    "$client_session_initial_utm_content": "String",
    "$client_session_initial_utm_medium": "String",
    "$client_session_initial_utm_source": "String",
    "$client_session_initial_utm_term": "String",
    "$initial_search_engine": "String",
    ...
    "$mcp_duration_ms": "String",
    "$mcp_error_message": "String",
    "$mcp_exec_tool_call_description": "String",
    "$mcp_exec_tool_call_name": "String",
    "$mcp_intent": "String",
    "$mcp_intent_source": "String",
    "$mcp_is_error": "String",
    "$mcp_listed_tool_names": "Array(String)",
    "$mcp_oauth_client_name": "String",
    "$mcp_organization_id": "String",
    "$mcp_project_id": "String",
    "$mcp_session_id": "String",
    "$mcp_source": "String",
    "$mcp_tool_category": "String",
    ...
    "$process_person_profile": "String",
    "$recording_status": "String",
    "$referrer": "String",
    "$referring_domain": "String",
    "$replay_minimum_duration": "String",
    "$replay_sample_rate": "String",
    "$raw_user_agent": "LowCardinality(String)",
    "$search_engine": "String",
    "$screen_height": "LowCardinality(String)",
    "$screen_name": "String",
    "$screen_width": "LowCardinality(String)",
    "$session_id": "String",
    "$session_entry_host": "String",
    "$session_entry_pathname": "String",
    "$session_entry_referrer": "String",
    "$session_entry_referring_domain": "String",
    "$session_entry_search_engine": "String",
    "$session_entry_url": "String",
    "$session_entry_utm_campaign": "String",
    "$session_entry_utm_content": "String",
    "$session_entry_utm_medium": "String",
    "$session_entry_utm_source": "String",
    "$session_entry_utm_term": "String",
    "$session_recording_event_trigger_activated_session": "String",
    "$session_recording_start_reason": "String",
    "$session_recording_url_trigger_status": "String",
    "$survey_id": "String",
    "$survey_completed": "String",
    "$survey_iteration": "String",
    "$survey_iteration_start_date": "String",
    "$survey_name": "String",
    "$survey_partially_completed": "String",
    "$survey_response": "String",
    "$survey_response_1": "String",
    "$survey_submission_id": "String",
    "$time": "String",
    "$timezone": "LowCardinality(String)",
    "$timezone_offset": "LowCardinality(String)",
    "$user_id": "String",
    "$viewport_height": "String",
    "$viewport_width": "String",
    "$web_vitals_CLS_value": "String",
    "$web_vitals_FCP_value": "String",
    "$web_vitals_INP_value": "String",
    "$web_vitals_LCP_value": "String",
    "$web_vitals_enabled_server_side": "LowCardinality(String)",
    "$window_id": "String",
    "action": "String",
    "action_name": "String",
    "address": "String",
...
PERSON_PROPERTIES_JSON_SUBCOLUMN_DECLARED_TYPES: dict[str, str] = {
    ...
    "$initial_app_build": "String",
    "$initial_app_name": "String",
    "$initial_app_namespace": "String",
    "$initial_app_version": "String",
    "$initial_browser": "LowCardinality(String)",
    "$initial_browser_language": "String",
    "$initial_browser_language_prefix": "String",
    "$initial_browser_type": "String",
    "$initial_browser_version": "LowCardinality(String)",
    "$initial_device": "String",
    "$initial_device_id": "String",
    "$initial_device_manufacturer": "String",
    "$initial_device_model": "String",
    ...
    "$initial_os_name": "String",
    "$initial_os_version": "LowCardinality(String)",
    "$initial_raw_user_agent": "LowCardinality(String)",
    "$initial_referrer": "String",
    "$initial_referring_domain": "String",
    "$initial_screen_height": "LowCardinality(String)",
    "$initial_screen_width": "LowCardinality(String)",
    "$initial_search_engine": "String",
    "$initial_utm_campaign": "String",
    "$initial_utm_content": "String",
    "$initial_utm_medium": "String",
    "$initial_utm_source": "String",
    "$initial_utm_term": "String",
    "$initial_viewport_height": "String",
    "$initial_viewport_width": "String",
    "$initial_wbraid": "String",
    "$os_name": "String",
    "$os": "LowCardinality(String)",
    "$os_version": "LowCardinality(String)",
    ...
    "$referring_domain": "String",
    "$email": "String",
    "$last_seen_survey_date": "String",
    "$organization_id": "String",
    "$product_tour_last_seen_date": "String",
    "$survey_last_seen_date": "String",
    "Email Domain": "String",
    "companyName": "String",
    "customer": "String",
    "email": "String",
    ...
    "name": "String",
    "organization_id": "String",
    "organization_member_count": "String",
    "role": "String",
